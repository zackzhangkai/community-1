...
![jaeger2](/styles/images/jaeger-2.png)
...
2. ingress没有注入sidecar的包，此时requestID是 xxxxxxx这种形式，非标准

![jaeger3](/styles/images/jaeger-3.png)
...
![jaeger4](/styles/images/jaeger-4.png)
...
## pod注入sidecar后会是加密文件，不方便抓包，改schema为http
